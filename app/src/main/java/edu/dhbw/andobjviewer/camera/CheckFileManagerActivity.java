...
public class CheckFileManagerActivity extends Activity {
                ...
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        if (!file.exists()) {
                            ...
                            Toast.makeText(this, res.getText(R.string.file_doesnt_exist), Toast.LENGTH_SHORT).show();
                            selectFile();
                        } else {
                            String fileName = data.getDataString();
                            if (!fileName.endsWith(".obj")) {
                                Toast.makeText(this, res.getText(R.string.wrong_file), Toast.LENGTH_SHORT).show();
                                selectFile();
                            } else {
                    ...
                    case RESULT_ERROR:
                        ...
                        if (data != null) {
                            ...
                            if (errorMessage != null)
                                Toast.makeText(this, extras.getString("error_message"), Toast.LENGTH_SHORT).show();
                        }
                        selectFile();
                        break;
                }
     ...
     *  {@link CheckFileManagerActivity#onActivityResult(int, int, Intent)} */
